...
public class WebGame {
    ...
    private static final Map<Integer, List<ChatMessage>> chatLogs = new ConcurrentHashMap<>();
    private static final Map<String, Session> sessions = new ConcurrentHashMap<>();
    private static final Map<String, List<String>> gameHandles = new ConcurrentHashMap<>();

    static {
        chatLogs.put(-1, new ArrayList<>());
    }
    ...
    public static int create(String visibility, boolean sidestep) {
        ...
        gameCounter++;
        chatLogs.put(gameId, new ArrayList<>());
    ...
    public static void addChat(String chat, int gameId) {
    ...
    public static List<ChatMessage> getChatLog(int gameId) {
