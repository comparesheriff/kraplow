...
public class Duel extends Card implements Playable {
    ...
    public boolean play(
        ...
        if (!(other instanceof CancelPlayer)) {
            ...
            while (true) {
                ...
                if (bangPlayed == -1) {
                    turn.damagePlayer(
                        other, players, currentPlayer, 1, currentPlayer, deck, discard, userInterface);
                ...
                if (currentBangPlayed == -1) {
                    turn.damagePlayer(
                        currentPlayer, players, currentPlayer, 1, null, deck, discard, userInterface);
    ...
    private void giveMollyStarkCards(
        Player player, Deck deck, int amountCards, UserInterface userInterface) {
