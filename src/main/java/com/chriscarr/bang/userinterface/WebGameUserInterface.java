...
public class WebGameUserInterface extends JSPUserInterface {
    ...
    public void sendMessage(String player, String message) {
        ...
        if (userFigureNames.get(player).contains("AI")
            ...
            addResponse(userFigureNames.get(player), somethingAI(player, message));
        }
    }
    ...
    private void setupMap() {
        ...
        // If there is only one human put them first so they can get there prefered role and character
        // if chosen
    ...
    public String removeResponse(String player) {
        return responses.get(userFigureNames.get(player)).removeFirst().getMessage();
    }
