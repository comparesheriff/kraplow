...
public enum Character {
  ...
  JOHNNYKISCH(
      "Johnny Kisch",
      "When playing blue or green card, discard all cards in play with same name",
      4),
  CLAUSTHESAINT(
      "Claus The Saint", "Draw one card for every player plus one, everyone else gets 1", 3),
  ...
  public static final List<Character> CHARACTERSSIDESTEP =
      List.of(
          CHUCKWENGAM,
          ELENAFUENTE,
          BELLESTAR,
